        ...
        <Container style={styles.container}>
          ...
          <Section style={styles.mainContent}>
            ...
            <Text style={styles.paragraph}>
              We noticed you've explored multiple Gen AI modules — that's a great start. But none of them are fully complete yet.
            </Text>
            ...
            <div style={styles.calloutBox}>
              ...
              <div style={styles.bulletContainer}>
                <Text style={styles.bulletPoint}>1️⃣ <strong>Pick one module to complete first</strong> — If you haven't finished {firstModuleTitle}, start there. It's the foundation.</Text>
                <Text style={styles.bulletPoint}>2️⃣ <strong>Dedicate just 30–60 minutes a day</strong> to stay on track and make real progress.</Text>
                <Text style={styles.bulletPoint}>3️⃣ <strong>Finish before you jump ahead.</strong> One completed project is worth more than three unfinished ones.</Text>
              </div>
            </div>

            <Text style={{...styles.paragraph, marginTop: "25px"}}>
              🎯 <strong>Time to focus and finish</strong>
            </Text>
