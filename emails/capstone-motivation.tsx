...
interface CapstoneMotivationProps {
  name?: string;
}

// Email template component
export const CapstoneMotivationEmail = ({ 
  name = "there"
}: CapstoneMotivationProps) => {
  return (
    <Html>
      <Head />
      <Preview>Keep the Momentum! Finish Your Core Features This Week</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Section style={styles.heroSection}>
            ...
            <Text style={styles.heroTitle}>Capstone Motivation</Text>
            <Text style={styles.heroSubtitle}>Keep Building Momentum!</Text>
          </Section>
          ...
          <Section style={styles.contentSection}>
            ...
            <Text style={styles.mainText}>
              You're doing great so far! Now it's time to focus on completing the <strong>core features</strong> of your Capstone Project before Week 2 begins.
            </Text>
            <Text style={styles.mainText}>
              Finishing this phase early gives you more time to:
            </Text>
          </Section>
          ...
          <Section style={styles.checklistSection}>
            <div style={styles.checklistItem}>
              ...
              <Text style={styles.checklistText}>Test and refine your product</Text>
            </div>
            
            <div style={styles.checklistItem}>
              <Text style={styles.checkmark}>✅</Text>
              <Text style={styles.checklistText}>Gather feedback from mentors and peers</Text>
            </div>
            
            <div style={styles.checklistItem}>
              <Text style={styles.checkmark}>✅</Text>
              <Text style={styles.checklistText}>Prepare for a strong Demo Day presentation</Text>
            </div>
          </Section>
          ...
          <Section style={styles.helpSection}>
            <Text style={styles.mainText}>
              Stay focused and keep pushing — you're building something amazing!
            </Text>
            <Text style={styles.mainText}>
...
export default CapstoneMotivationEmail;
