...
interface CapstoneDemoDayPrepProps {
  name?: string;
}

// Email template component
export const CapstoneDemoDayPrepEmail = ({ 
  name = "there"
}: CapstoneDemoDayPrepProps) => {
  return (
    <Html>
      <Head />
      <Preview>Demo Day Is Tomorrow — Time to Prep Your Pitch!</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Section style={styles.heroSection}>
            ...
            <Text style={styles.heroTitle}>Demo Day Preparation</Text>
            <Text style={styles.heroSubtitle}>It's Time to Polish Your Pitch!</Text>
          </Section>
          ...
          <Section style={styles.welcomeSection}>
            ...
            <Text style={styles.welcomeText}>
              Demo Day is just <strong>1 day away</strong>! Now's the time to polish your demo and rehearse your pitch.
            </Text>
          </Section>
          ...
          <Section style={styles.questionsSection}>
            <div style={styles.questionItem}>
              ...
              <Text style={styles.questionText}>Make sure your AI solution runs smoothly</Text>
            </div>
            
            <div style={styles.questionItem}>
              <Text style={styles.checkmark}>✅</Text>
              <Text style={styles.questionText}>Prepare a clear, confident explanation of your project</Text>
            </div>
            
            <div style={styles.questionItem}>
              <Text style={styles.checkmark}>✅</Text>
              <Text style={styles.questionText}>Practice answering questions from peers and experts</Text>
            </div>
            
            <Text style={styles.encouragementText}>
              You've worked hard — now show everyone what you've built!
            </Text>
          </Section>
          ...
          <Section style={styles.ctaSection}>
            <Button style={styles.ctaButton} href="https://www.buildfastwithai.com/premium/capstone">
              Review Your Capstone
            </Button>
            
            <Text style={styles.signoffText}>
              Can't wait to see your demo shine!
            </Text>
...
export default CapstoneDemoDayPrepEmail;
